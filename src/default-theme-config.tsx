...
export const DEFAULT_THEME: KernuxThemeConfig = {
  ...
  footer: {
    ...
    copyright: (
      <p className="text-sm opacity-75">
        &copy; {new Date().getFullYear()} Zentrum für Digitale Souveränität der
        Öffentlichen Verwaltung (ZenDiS) GmbH. Alle Rechte vorbehalten.
      </p>
    ),
  },
  head: function useHead() {
    ...
    const { description, canonical, image, metaDescription, metaTitle } =
      frontMatter;
    return (
      <>
        ...
        <meta
          property="og:title"
          content={metaTitle ? metaTitle : cleanHtml(title)}
        />
        ...
        <meta
          name="description"
          content={metaDescription ? metaDescription : cleanHtml(description)}
        />
        ,
        <meta
