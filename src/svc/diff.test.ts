...
describe('calculateAllowedDiffOptions', () => {
  it('should', () => {
    ...
    const result = calculateAllowedDiffOptions(selectedSource, selectedTarget, versions)
    ...
    expect(result).toEqual([expectedAllowedVersionSource, expectedAllowedVersionTarget])
  })
})
