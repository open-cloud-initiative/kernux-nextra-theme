...
export const combineAnswers = (data: Answers, questionnaire: QuestionFS): Questionnaire => {
  return {
    ...data,
        ...
        elements: q.elements.map((e, j) => {
          return {
            ...
            subQuestions: e.subQuestions.map((sq, k) => {
              ...
              if (!data.questions || data.questions[i] === null || data.questions[i] === undefined) {
                return {
                  ...sq,
                  answer: null,
                  message: '',
              ...
              return {
                ...
                message: data.questions[i].elements[j]?.subQuestions[k]?.message,
              } as any
            }),
          }
        }),
