...
const CopyCode: FunctionComponent<Props> = props => {
  ...
  return (
    ...
    >
      {props.fileName && <div className="bg-gray-200 p-1 px-2 text-sm text-gray-700">{props.fileName}</div>}
      <button
        onClick={handleCopy}
      ...
      <div className="relative">
        <Highlighter
          ...
          customStyle={props.transparentBackground ? {backgroundColor: 'transparent'} : {backgroundColor: '#F2F4F6'}}
        />
      </div>
    </div>
  )
