...
const CommentForm = ({onCommentCreated, discussionId, isReply, setAnswer}: props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-4">
      <MarkdownEditor
        ...
        placeholder={isReply ? 'Schreiben Sie eine Antwort...' : 'Schreiben Sie einen Kommentar...'}
      ...
      <div className="mt-4 flex justify-end">
        <Button variant="secondary" type="submit" disabled={comment.content.length === 0 || loading}>
          {loading ? (
