  ...
  if (
    ...
    return (
      <NavigationMenuItem key={item.route}>
        <NavigationMenuTrigger className="break-words">
          {item.title}
        </NavigationMenuTrigger>
        <NavigationMenuContent>
              ...
              <li
                ...
                className={
                  index < array.length - 1
                    ? "border-b border-border/50 pb-2 mb-2"
                    : ""
                }
              >
    ...
    <NavigationMenuItem key={item.route || (item as PageItem).href}>
      <NavigationMenuLink asChild>
        <NextLink
          className={clsx(
            "whitespace-nowrap",
            "hover:text-kern-action-default p-sm rounded-lg font-medium text-sm",
            {
        ...
        <div className="flex flex-row flex-wrap items-center justify-end gap-4">
          ...
          <div className="md:block hidden">
            {themeConfig.docsRepositoryBase && (
              <a
                href={themeConfig.docsRepositoryBase}
          ...
          {!themeConfig.hidePrimaryMenu && (
            <button
              className="block p-sm xl:hidden"
              aria-label="Menu"
          ...
          {themeConfig.accessibilityLanguages && (
            <AccessibilityLanguages
              leichteSpracheHref={
                themeConfig.accessibilityLanguages?.leichteSpracheHref
              }
              gebaerdenspracheHref={
                themeConfig.accessibilityLanguages?.gebaerdenSprachenHref
              }
            />
          )}
        </div>
