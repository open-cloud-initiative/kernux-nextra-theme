...
import {DatePicker, Select, Button, Input, Textarea} from '@open-cloud-initiative/kernux-react'
...
export default function SelfAssessmentMainData({form, setActiveStepIndex}: SAAuditQuestionsProps) {
              ...
              <div className="col-span-6">
                <Textarea
                  ...
                  {...form.register('context', {
                    ...
                    maxLength: {
                      value: 500,
                      message: 'Der Kontext darf maximal 500 Zeichen lang sein.',
                    },
                  })}
                />
              </div>
